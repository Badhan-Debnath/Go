// =======Options START=======
var  authConfig  =  {
  siteName : "Badhan's Share" ,  // site name
  version : "1.1.2" ,  // program version
  theme: "acrou",
  // It is strongly recommended to use your own client_id and client_secret
  client_id: "202264815644.apps.googleusercontent.com",
  client_secret: "X4Z3ca8xfWDb1Voo-F9a7ZxJ",
  refresh_token : "1//0g1piD_i7dVEACgYIARAAGBASNwF-L9IrBrljux604Uj8SiJC9-_CPQ9JnS4qFhhETOzYmwIsj3_-V6C1-aijyq-nnGdYm6ldU-c" ,  // authorized token
  /**
  ...
  "roots": [
    {
      id: "1NwPwgRX_XB5rYEXwMQz4HNLLBO903i3w",
      name: "Badhan"
    },
    {
      id: "root",
...
var themeOptions = {
  cdn: "https://cdn.jsdelivr.net/gh/ParveenBhadooOfficial/goindex-theme-acrou",
...
<head>
  ...
  <link rel="icon" href="https://badhan-debnath.github.io/img/me.png">
  <style>
...
<body>
  ...
  <!-- Load Facebook SDK for JavaScript -->
      ...
      <div class="fb-customerchat"
        ...
        page_id="424729344920319">
      </div>

        <footer>
          <center>
              <p> Copyright &copy; 2020-<script>document.write(new Date().getFullYear())</script> <a style="text-decoration:none;" href="https://www.facebook.com/badhan.debnath.bd/">BADHAN DEBNATH</a> All Rights Reserved</p>
          </center>
        </footer>
</body>
</html>
